...
read1 = Options.read1; read2 = Options.read2; p_read1=Options.p_read1; p_read2=Options.p_read2; thread=Options.thread; output=Options.output

maxcpu = 40

outputlog_path = "/BiO2/users/jjg/tools/Somatic_Pipeline/exp/out/log.log"
out = "/BiO2/users/jjg/tools/Somatic_Pipeline/exp/out/"
tmp = "/BiO2/users/jjg/tools/Somatic_Pipeline/temp/"

print(read1)
print(read2)

reference_genome =  "/BiO2/users/jjg/DB/hg38.fa"
